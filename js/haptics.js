// ─── Haptic + Motion engine for bandmusicgames.party ────────────────────────
// Vibration API: Android Chrome ✓  iOS Safari ✗ (silent no-op)
// DeviceOrientation: iOS 13+ (requestPermission) + Android (no permission)
